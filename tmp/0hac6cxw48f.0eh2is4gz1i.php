				...
				<section id="wrapper">
						...
						<div class="layout">
							...
							<section id="inscription">
								...
								<p>Seuls votre pseudo ainsi que votre photo seront visibles par les autres utilisateurs</p>
								...
								<div id="champs-left">
									...
									<h2>Mot de passe</h2>
									<input type="password" name="mdp1" placeholder="mdp" />
									<h2>Confirmer le mdp :</h2>
									<input type="password" name="mdp2" placeholder="mdp" />
									<h2>Majorité</h2>
										<input type="radio" name="majority" value="majeur"><label>Majeur</label>
										<input type="radio" name="majority" value="mineur" checked><label>Mineur</label>
								...
								<!--		<div id="add-wine2">
											<div id="add2">
												<input type="submit" name="ajout-photo" value="+"/>
																							</div>
										</div>
								</div>-->
								<!-- fin champs right -->
...
lorsque vous souhaiterez prendre renvez-vous avec un troqueur.</p>
							...
							<input id="envoyer" type="submit" name="envoyer" value="Je m'inscris" />
							</form>
							</section>
							<!-- fin inscription -->
